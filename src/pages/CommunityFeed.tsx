                  ...
                  >
                    ...
                    <Dialog open={isNewPostDialogOpen} onOpenChange={setIsNewPostDialogOpen}>
                      <DialogTrigger asChild>
                        <div className="flex-1 bg-slate-50 hover:bg-white hover:shadow-inner hover:ring-2 hover:ring-primary/5 rounded-[1.75rem] px-8 py-4 text-slate-400 font-bold cursor-pointer transition-all border border-slate-100/50">

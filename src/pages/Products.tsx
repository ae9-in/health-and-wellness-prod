  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F9F5EE]">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 pt-8 gap-6 bg-gradient-to-br from-[#2C4A2E] to-[#4A3A2A] text-white rounded-[2.5rem] p-8 shadow-2xl border border-[#8C4A2A]/60">
          <div className="max-w-2xl">
            <h1 className="font-display text-4xl md:text-5xl font-bold mb-4 flex items-center gap-4 text-white">
          ...
          <div className="bg-[#F9F5EE] px-4 py-2 rounded-full text-[#4A3A2A] font-semibold text-sm shadow-sm">
          ...
          <div className="flex-1 min-h-[400px]">
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center h-full bg-[#2C4A2E] rounded-[3rem] border border-[#8C4A2A] p-12 text-center text-white">
                ...
                <Button onClick={clearFilters} variant="outline" className="rounded-full border-white/60 text-white">Clear All Filters</Button>
              </div>
            ) : (
